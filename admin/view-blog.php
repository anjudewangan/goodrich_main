...
<head>
	...
	<!-- Title -->
	<title>Goodrich | Manage Blog</title>
											...
											<tbody>
												...
												?>
														<tr>
															...
															<td><?php echo wordwrap($record['title'], 50, "<br>\n"); ?></td>
															<td><?php echo wordwrap($record['external_url'], 50, "<br>\n"); ?></td>
															<td>
																<div class="btn-icon-list">
																	<a href="blog.php?id=<?= $record['id']; ?>" class="btn ripple btn-primary btn-icon"><i class="fa fa-edit"></i></a>
																	<a style="cursor:pointer;" onclick="return deleteconfig('<?= $record['id']; ?>','blogs')" class="btn btn-danger btn-icon"><i class="fa fa-trash"></i></a>
																</div>
															</td>
														</tr>
												<?php }
