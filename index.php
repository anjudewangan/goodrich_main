...
<body>
  ...
  <div class="footer-parallax-container">
    ...
    <div class="section-bg-image parallax-window" data-natural-width="1920" data-natural-height="1080" data-parallax="scroll" data-bleed="0" data-image-src="./assets/images/dashboard/bg-7.webp">
      <div class="container content">
          ...
          <ul class="slides">
            <li>
              <div class="advs-box advs-box-multiple boxed-inverse" data-anima="scale-rotate" data-trigger="hover">
                <a class="img-box"><img loading="lazy" class="anima" src="./assets/images/dashboard/karnal-plant1.webp" alt="Aerial view of Goodrich Potato Main Campus in Karnal (Haryana), depicting industrial activity and manufacturing process." width="370" height="227"></a>
            ...
            <li>
              <div class="advs-box advs-box-multiple boxed-inverse" data-anima="scale-rotate" data-trigger="hover">
                <a class="img-box"><img loading="lazy" class="anima" src="./assets/images/dashboard/karnal-plant.webp" alt="A truck parked in front of the Goodrich Potato Campus in Kutail (Haryana)  Plant building." width="370" height="227"></a>
                <div class="advs-box-content">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="div-shadow">
              ...
              <img loading="lazy" width="360" height="239" src="./assets/images/dashboard/sorting.webp" alt="Potatoes being loaded onto a conveyor belt for cleaning, sorting, and washing.">
          ...
          <div class="col-md-4">
            <div class="div-shadow">
              ...
              <img loading="lazy" width="360" height="239" src="./assets/images/dashboard/peeling.webp" alt="Potatoes being steam peeled in a machine, undergoing processing for further use.">
              <div class="caption-bottom">
                <h2>STEAM PEELING</h2>
          ...
          <div class="col-md-4">
            <div class="div-shadow">
              ...
              <img loading="lazy" width="360" height="239" src="./assets/images/dashboard/finished.webp" alt="Two men in white coats standing in front of a machine, possibly used for cooking and mashing potatoes.">
              <div class="caption-bottom">
            ...
            <div class="row">
                ...
                <div class="adv-img-double-content">
                  <a class="img-box img-fade-bottom">
                    <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                      <img loading="lazy" width="263" height="175" alt="A bowl of white potato flakes" src="./assets/images/products/flake.webp">
              ...
              <div class="col-lg-3 col-xs-6" onclick="granulesClick()">
                <div class="adv-img-double-content">
                  <a class="img-box img-fade-bottom">
                    <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                      <img loading="lazy" width="263" height="175" alt="A bowl of white potato granules" src="./assets/images/products/granule.webp">
                      <div class="caption anima">
                        <h3>GRANULES</h3>
                        <p>
              ...
              <div class="col-lg-3 col-xs-6" onclick="flourClick()">
                <div class="adv-img-double-content">
                  <a class="img-box img-fade-bottom">
                    <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                      <img loading="lazy" width="263" height="175" alt="A bowl of white potato flour" src="./assets/images/products/flour.webp">
                      <div class="caption anima">
                        <h3>Semolina</h3>
              ...
              <div class="col-lg-3 col-xs-6 air-dried-responsive" onclick="airdriedClick()">
                <div class="adv-img-double-content">
                  <a class="img-box img-fade-bottom">
                    <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                      <img loading="lazy" width="263" height="175" alt="A bowl of white potato cubes" src="./assets/images/products/cube.webp">
                      <div class="caption anima">
                        <h3>AIR DRIED</h3>
                        <p>
                ...
                <div class="adv-img-double-content">
                  <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                    <a class="img-box img-fade-bottom" href="potato-flakes">
                      <img loading="lazy" width="555" height="370" alt="A bowl of white potato flakes on a wooden table" src="./assets/images/products/L1-Flake.webp">
                    </a>
                    <div class="caption anima">
                      <h3>Potato Flakes</h3>
                      <p>
                ...
                <div class="adv-img-double-content">
                  <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                    <a class="img-box img-fade-bottom" href="dehydrated-potato-products#granule-sec">
                      <img loading="lazy" width="555" height="370" alt="A bowl of white potato granules on a wooden table" src="./assets/images/products/L1-Granules.webp">
                    </a>
                    <div class="caption anima">
                ...
                <div class="adv-img-double-content">
                  <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                    <a class="img-box img-fade-bottom" href="dehydrated-potato-products#flour-sec">
                      <img loading="lazy" width="555" height="370" alt="A bowl of white potato flour on a wooden table" src="./assets/images/products/L1-Flour.webp">
                    </a>
                    <div class="caption anima">
            ...
            <div class="row products-row">
                ...
                <div class="adv-img-double-content">
                  <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                    <a class="img-box img-fade-bottom" href="dehydrated-potato-products#air-dried-sec">
                      <img loading="lazy" width="360" height="240" alt="A bowl of white potato slices on a wooden table" src="./assets/images/products/L1-Slices.webp">
              ...
              <div class="col-lg-4 col-xs-4">
                <div class="adv-img-double-content">
                  <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                    <a class="img-box img-fade-bottom" href="dehydrated-potato-products#air-dried-sec">
                      <img loading="lazy" width="360" height="240" alt="A bowl of white potato dices on a wooden table" src="./assets/images/products/L1-cube.webp">
              ...
              <div class="col-lg-4 col-xs-4">
                <div class="adv-img-double-content">
                  <div class="img-box adv-img adv-img-half-content" data-anima="fade-bottom" data-trigger="hover" data-anima-out="hide">
                    <a class="img-box img-fade-bottom" href="dehydrated-potato-products#air-dried-sec">
                      <img loading="lazy" width="360" height="240" alt="A bowl of white potato shreds on a wooden table" src="./assets/images/products/L1-shreds.webp">
        ...
        <div class="row padding-bottom-col">
          <div class="col-lg-3 col-xs-6">
            <div class="img-box adv-img adv-img-full-content">
              <div class="img-box">
                <img loading="lazy" width="263" height="367" src="./assets/images/dashboard/1.webp" alt="Potato soup with crispy bacon and crunchy nuts, a comforting and flavorful dish.">
              </div>
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="img-box adv-img adv-img-full-content">
              <div class="img-box">
                <img loading="lazy" width="263" height="367" src="./assets/images/dashboard/2.webp" alt="Various types of bread on a wooden table.">
              </div>
              <a href="#" class="caption-bg img-box">
                <div class="caption">
                  <div class="inner">
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="img-box adv-img adv-img-full-content">
              <div class="img-box">
                <img loading="lazy" width="263" height="367" src="./assets/images/dashboard/3.webp" alt="A delectable burger adorned with veggies .">
              </div>
              <a href="#" class="caption-bg img-box">
                <div class="caption">
                  <div class="inner">
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="img-box adv-img adv-img-full-content">
              <div class="img-box">
                <img loading="lazy" width="263" height="367" src="./assets/images/dashboard/4.webp" alt="Aloo Bhujiya: A spoon of Indian dish made with crispy potato strands, spices, and herbs.">
              </div>
              <a href="#" class="caption-bg img-box">
                <div class="caption">
                  <div class="inner">
      ...
      <div class="container content">
        <div class="row">
          ...
          <div class="col-md-7 col-sm-12 text-center-sm" data-anima="fade-right">
            ...
            <img loading="lazy" width="653" height="376" class="responsive-img" src="./assets/images/dashboard/farmer.webp" alt="A man in a hat holds a basket of potatoes, showcasing a traditional harvest scene.">
          </div>
        </div>
        <hr>
        <hr class="space m">
        <div class="row order-reverse">
          <div class="col-md-7 col-sm-12 text-center-sm" data-anima="fade-left">
            <hr class="space m visible-sm">
            <img loading="lazy" width="653" height="376" class="responsive-img" src="./assets/images/dashboard/Sustainable.webp" alt="Agricultural workers tending to crops on a farm, with a picturesque landscape in the background.">
          </div>
          <div class="col-md-5 col-sm-12 text-center-sm">
            <div class="title-base text-left text-center-sm">
              <hr>
      ...
      <div class="container content">
        ...
        <table class="grid-table border-table" data-anima="fade-bottom" data-timeline="asc">
          <tbody>
            <tr>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/al-kabeer.webp" alt="al-kabeer">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/alnutri.webp" alt="alnutri">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/balaji.webp" alt="balaji">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/bikaji.webp" alt="bikaji">
              </td>
            </tr>
            <tr>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/dfm.webp" alt="dfm">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/diamond.webp" alt="diamond">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/engel.webp" alt="engel">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/haldiram.webp" alt="haldiram">
              </td>
            </tr>
            <tr>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/indian-army.webp" alt="indian-army">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/itc.webp" alt="itc">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/parle.webp" alt="parle">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/ttk.webp" alt="ttk">
              </td>
            </tr>
            <tr>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/bikanervala.webp" alt="bikanervala">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/cl5.webp" alt="lotte">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/cl7.webp" alt="chhajed">
              </td>
              <td>
                <img loading="lazy" width="235" height="112" class="anima responsive-img" src="./assets/images/clients/cl6.webp" alt="roble">
              </td>
            </tr>
          </tbody>
        </table>
