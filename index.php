      ...
      <div class="container content" style="padding-bottom: 20px;">
        ...
        <div class="row">
          <div class="col-md-12 col-center text-center">
            <img loading="lazy" fetchpriority="high" width="555" height="324" src="./assets/images/dashboard/map.webp" alt="A world map with pins indicating various countries." class="responsive-img">
          </div>
        </div>
      </div>
    </div>
