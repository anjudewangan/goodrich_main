      ...
      <div class="container content">
        ...
        <div class="row">
          ...
          <form method="post" class="form-box actionForm" action="./assets/php/form-functions.php" enctype="multipart/form-data">
              <input type="hidden" name="btnform" value="career">
              <div class="row">
                <div class="col-md-6">
                  <p>Name</p>
                  <input id="name" name="name" maxlength="50" placeholder="" type="text" class="form-control" required />
                  <div class="Inpt name"></div>
                </div>
                <div class="col-md-6">
                  <p>Surname</p>
                  <input id="surname" name="surname" maxlength="50" placeholder="" type="text" class="form-control" required />
              ...
              <div class="row">
                <div class="col-md-3">
                  <p>Town/City</p>
                  <input id="town" name="city" maxlength="50" placeholder="" type="text" class="form-control" required />
                ...
                <div class="col-md-4">
                  <p>Address</p>
                  <input id="address" name="address" maxlength="100" placeholder=" " type="text" class="form-control" required />
                  <div class="Inpt address"></div>
                </div>
                <div class="col-md-2">
                  <p>Zip Code</p>
                  <input id="zip" name="zipcode" maxlength="6" placeholder=" " type="text" class="form-control TypeInt" required />
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <p>Email</p>
                  <input id="email" name="email" maxlength="100" placeholder=" " type="email" class="form-control" required />
                  <div class="Inpt email"></div>
                </div>
                <div class="col-md-4">
                  <p>Job Title</p>
                  <input id="tob_title" name="tob_title" maxlength="100" placeholder=" " type="text" class="form-control" required />
              ...
              <div class="row">
                <div class="col-md-12">
                  <hr class="space xs" />
                  <p>About you</p>
                  <textarea id="messagge" name="about_us" rows="4" maxlength="1000" class="form-control" required></textarea>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <button class="anima-button circle-button btn-xs btn" type="submit"><i class="im-envelope-2"></i>Submit</button>
          ...
          <div class="col-md-4">
            ...
            <p>
              Be a part of a
              team that transforms potatoes into endless possibilities!
            </p>
          </div>
        </div>
      </div>
