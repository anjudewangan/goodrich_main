          ...
          <div class="navbar navbar-main navbar-middle">
            <div class="container">
              <div class="navbar-header">
                ...
                <img loading="lazy" class="logo-default scroll-hide" src="./assets/images/logos/logo.png" alt="logo">
                <img loading="lazy" class="logo-default scroll-show" src="./assets/images/logos/logo.png" alt="logo">
                <img loading="lazy" class="logo-retina" src="./assets/images/logos/logo.png" alt="logo">
              </a>
              </div>
              <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                  ...
                  <li class="logo-item">
                    <a href="./">
                      <img loading="lazy" src="./assets/images/logos/logo.png" alt="logo">
                    </a>
                  </li>
                  <li class="dropdown">
    ...
    <div class="col-lg-3 col-xs-12 footer-left">
      ...
      <div class="row vission-img">
        <div class="col-lg-6 col-xs-4">
          <img loading="lazy" src="./assets/images/goodrich-cereals/cereals-story-potato.png" width="100px"
