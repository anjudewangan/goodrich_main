...
class Pagination
{
	...
	function create_links()
	{
		...
		if ($currentPage > 1){
		$aa=$currentPage - 1;
			$output .= sprintf('<li><a href="' . $link . '">&#171; Previous</a></li> ', $currentPage - 1);
		}
		...
		return '<div class="dataTables_paginate paging_bs_full" id="DataTables_Table_0_paginate"><ul class="pagination">' . $output . '</ul></div>';
	}
}
